...
* **What's this Origin Trial thing that's needed for deployment of a WebUSB-based project?** Since WebUSB isn't yet standardized, but the Chrome team wants to get real developer feedback on the API, they've developed a mechanism to selectively enable experimental versions of APIs on specific origins. Go to https://bit.ly/OriginTrials to learn more, and visit https://jpchase.github.io/OriginTrials/check-token.html if you want to see the internals of a token.
